...
const DEMO_DATA: CommentListingDataType = {
  ...
  date: "May 20, 2024",
  comment:
  "Absolutely loved my stay at this property! The house was spotless, well-furnished, and had all the amenities I needed. The neighborhood was quiet and safe, making it the perfect place to relax. Definitely coming back!",
  starPoint: 5,
};
