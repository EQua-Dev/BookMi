...
const DEMO_DATA = [
  {
    id: 1,
    clientName: "Njoku Samson",
    clientAddress: "Awka",
    content:
      "This place is exactly like the picture posted on Bookmi. Great service, we had a great stay!",
  },
  {
    id: 2,
    clientName: "Oruma Ncheka",
    clientAddress: "Abuja",
    content:
      "This place is exactly like the picture posted on Bookmi. Great service, we had a great stay!",
  },
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  return (
    <div className={`nc-SectionClientSay relative ${className} `}>
      <Heading desc="Let's see what people think of Bookmi" isCenter>
