...
export const includes_demo = [
  { name: "Guided Tour of Olumo Rock" },
  { name: "Transportation from Hotel to Olumo Rock and Return" },
  { name: "Complimentary Bottled Water" },
  { name: "Traditional Yoruba Meal" },
  { name: "Olumo Rock Entrance Fee" },
  { name: "Access to Olumo Rock Art Gallery and Museum" },
];
