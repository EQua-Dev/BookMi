    ...
    return (
      <div className="listingSection__wrap !space-y-6">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold">
          Beach House in Eko Atlantic City
        </h2>
        ...
        <div className="flex items-center space-x-4">
          ...
          <span>
            ...
            <span className="ml-1"> Victoria Island, Lagos</span>
          </span>
        </div>
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div>
          ...
          <span className="block mt-2 text-neutral-500 dark:text-neutral-400">
            Eko Atlantic City, Victoria Island, Lagos State, Nigeria
          </span>
        </div>
        ...
        <div className="aspect-w-5 aspect-h-5 sm:aspect-h-3 ring-1 ring-black/10 rounded-xl z-0">
          <div className="rounded-xl overflow-hidden z-0">
            <iframe
              ...
              src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAGVJfZMAKYfZ71nzL_v5i3LjTTWnCYwTY&q=Victoria+Island, Lagos"
            ></iframe>
          </div>
        </div>
      </div>
